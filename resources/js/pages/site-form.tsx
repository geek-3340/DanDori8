...
export default function SiteForm() {
  return (
    <div className="max-w-[680px]">
      <h3 className="m-0 mb-4.5 font-gothic text-[21px] font-black text-app-text">
        {/* 新規現場 / 現場を編集 */}
        新規現場
      </h3>
      ...
      <div className="grid gap-5 rounded-[14px] border border-[#D8E0E8] bg-white p-[22px]">
        ...
        <label className="grid gap-1.5">
          <span className="font-gothic text-[12.5px] font-bold text-app-asphalt">現場名</span>
          <input
        ...
        <div className="grid gap-2.5">
          <span className="font-gothic text-[12.5px] font-bold text-app-asphalt">
            工程を登録{' '}
          ...
          <div className="grid gap-3 rounded-[11px] border border-[#E3EAF1] bg-[#F7FAFC] p-3.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <select
                className="min-w-[150px] flex-1 rounded-[9px] border border-[#D8E0E8] bg-white px-3 py-2.5 font-ibm text-[13.5px] text-app-asphalt focus:border-transparent focus:outline focus:outline-2 focus:outline-app-secondary"
                defaultValue=""
              >
            ...
            <div className="flex flex-wrap items-center gap-2">
              <label className="flex min-w-[130px] flex-1 flex-col gap-[3px]">
                ...
                <input
                  type="date"
                  className="rounded-[9px] border border-[#D8E0E8] bg-white px-[11px] py-2.25 font-['IBM_Plex_Mono'] text-[13px] text-app-asphalt focus:border-transparent focus:outline focus:outline-2 focus:outline-app-secondary"
                />
              </label>
              ...
              <button
                type="button"
                className="self-end rounded-[9px] border-0 bg-app-primary px-4 py-2.5 font-gothic text-[12.5px] font-bold text-white"
              >
                ＋ 追加
              </button>
            </div>
          ...
          <div className="grid gap-1.5">
            <div className="flex items-center gap-2.5 rounded-[9px] border border-[#D8E0E8] bg-white px-[13px] py-2.25">
              <span className="h-2.5 w-[18px] shrink-0 rounded-[3px] bg-[linear-gradient(180deg,#3D4855,#2E3742)]" />
              <span className="flex-1 font-gothic text-[13.5px] font-bold text-app-asphalt">準備工</span>
              <span className="font-['IBM_Plex_Mono'] text-[11.5px] text-app-link">2026/06/01 〜 2026/06/18</span>
              <span title="削除" className="shrink-0 cursor-pointer text-[15px] text-[#B8C4D0] hover:text-[#F08519]">
                ×
              </span>
            </div>
            <div className="flex items-center gap-2.5 rounded-[9px] border border-[#D8E0E8] bg-white px-[13px] py-2.25">
              <span className="h-2.5 w-[18px] shrink-0 rounded-[3px] bg-[linear-gradient(180deg,#3D4855,#2E3742)]" />
              <span className="flex-1 font-gothic text-[13.5px] font-bold text-app-asphalt">路盤工</span>
        ...
        <div className="mt-0.5 flex justify-end gap-2.5">
          <button
            type="button"
            className="rounded-[9px] border border-[#D8E0E8] bg-white px-5 py-[11px] font-gothic text-[13px] font-bold text-app-link"
          >
            キャンセル
          </button>
          <button
            type="button"
            className="rounded-[9px] border-0 bg-app-secondary px-6 py-[11px] font-gothic text-[13px] font-bold text-white shadow-[0_4px_12px_rgba(35,169,198,.25)]"
          >
            {/* 現場を作成 / 更新する */}
            現場を作成
          </button>
