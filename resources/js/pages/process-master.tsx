export default function ProcessMaster() {
  return (
    <div>
      <h3 className="m-0 mb-1 font-['Zen_Kaku_Gothic_New'] text-[21px] font-black text-app-primary">工程マスタ</h3>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex items-center gap-3 rounded-[12px] border border-[#D8E0E8] bg-white px-4 py-3.5">
          ...
          <span title="削除" className="flex-shrink-0 cursor-pointer text-base text-[#B8C4D0] hover:text-[#F08519] hover:font-bold">
            ×
          </span>
        </div>
